...
## 5. Cloud Connector Instance size selection. Uncomment cc_instance_size line with desired vm size to change
##    (Default: "small") 
...
## 10. Provide the domain names you want Route53 to redirect to Cloud Connector for ZPA interception. Only applicable for base + zpa or zpa_enabled = true
...
## 17. Provide your existing Cloud Connector private subnet IDs. Only uncomment and modify if you set byo_subnets to true.
...
#####################################################################################################################
      ...
      ##### resource requirements for Workload Route Table swaps. E.g. "custom_cc"                           #####
      #####                                     **** Note ****                                           #####
...
## 22. By default, AWS Lambda resources are not created. Uncomment if you want to enable Lambda configuration in your VPC
##     Enabling will track the health of a pair of specified Cloud Connected deployed and automatically swap ENI
##     information between primary and secondary for any route tables specified in variables workload_route_table_ids_to_cc_1
##     and workload_route_table_ids_to_cc_2 below. (Default: false)

#lambda_enabled                              = true

## 23. Provide your existing Workload Route Table IDs. Route Table IDs must be added as a list and should be paired to
